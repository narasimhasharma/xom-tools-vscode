...
const eventContentArr = (eventLogData) => {
...
export const processDecompositionLog = (eData, lineAt, lineCount, renderTab, log) => {
            ...
            if(line.includes('AsIs Assets Tree')) {
                ...
                for (; j < lineCount; ++j) { 
                    ...
                    if(line.includes('[Asset]')) {
                        ...
                        asIsAssetData += `<div class='panel'><pre style='line-height:1.0;'>Asset Reference Id: ${assetRefId}</pre></div>`;
...
export const processOrchestrationLog = (eData, lineAt, lineCount, renderTab, log) => {
